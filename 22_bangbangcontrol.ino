...
#define _DUTY_MAX 1790 // 2000
#define _DUTY_NEU 1364 // 1500
#define _DUTY_MIN 780 // 1000

#define _SERVO_ANGLE_DIFF  75  // Replace with |D - E| degree
#define _SERVO_SPEED       90  // servo speed

#define _BANGBANG_RANGE    1010  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return (620 + -2.22*a_value + 2.01E-03*a_value*a_value); 
  //return ???;
}
